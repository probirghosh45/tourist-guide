...
const SylhetService = () => {
    ...
    useEffect(() => {
        fetch("https://raw.githubusercontent.com/Supriya-debnath/tourist-guide-visit-client/main/public/servicedb.json")
            .then(res => res.json())
      ...
      const sylhetDivision = services.filter(res =>res.division === "Sylhet Division")
